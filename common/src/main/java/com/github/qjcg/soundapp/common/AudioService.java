...
public class AudioRecordingService extends Service {
    ...
    public class RecordingReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            AudioRecordingService.this.saveRecording();
        }
    }

    protected static String TAG = "AudioRecordingService";
    public static String EXTRA_FILENAME = "filename";
    public static String DEFAULT_AUDIO_EXTENSION = ".mp3";
    public static String INTENT_STOP_AUDIO_RECORDING = "com.github.qjcg.soundapp.intent.STOP_RECORDING";
    ...
    public void onCreate() {
        ...
        IntentFilter intentDictRunning = new IntentFilter(INTENT_STOP_AUDIO_RECORDING);
        ...
        // notification
        Intent i = new Intent(this, StopAudioRecorderActivity.class);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(state)) {
            Log.d("AudioRecordingService", "SDCARD was not mounted: " + state);
            // return 0;
        }
         ...
         */
        if (intent != null && intent.getStringExtra(EXTRA_FILENAME) != null) {
            this.mAudioResultsFile = intent.getStringExtra(EXTRA_FILENAME);
        }
        if (this.mAudioResultsFile == null || "".equals(this.mAudioResultsFile)) {
            this.mAudioResultsFile = "/sdcard/audio_result_file_"
                    + System.currentTimeMillis() + DEFAULT_AUDIO_EXTENSION;
        }
